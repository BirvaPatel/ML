...
print ('First 30 images per class are considered as Training and rest as testing')
# Normalization
...
itr1 = model.fit(train_generator,verbose=1, epochs=20,shuffle=True)   
itr2 = model.fit(train_generator,verbose=1, epochs=20,shuffle=True)
itr3 = model.fit(train_generator,verbose=1, epochs=20,shuffle=True)
##################################################### Results ################################################
score = model.evaluate(test_generator)
stop = time.time()
print(f"Training accuracy time with pretrained Alexnet model with Caltech101: {stop - start}s")
